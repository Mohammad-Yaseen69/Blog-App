        ...
        <section className='w-full relative my-4 items-center flex justify-between px-8'>
            ...
            <div className=''>
                ...
                <div className='ss:hidden'>
                    ...
                    <div className={`py-3 flex items-center max-xs:w-[200px] justify-center transition-all w-[200px] h-[100vh] rounded-lg bg-black absolute -top-4 ${toggle ? 'left-[0px]' : '-left-[300px] ' }`}>
